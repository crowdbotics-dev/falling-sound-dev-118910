"""
Django settings for falling_sound_dev_118910 project.
...
ROOT_URLCONF = 'falling_sound_dev_118910.urls'
...
WSGI_APPLICATION = 'falling_sound_dev_118910.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_sound_dev_118910 API",
    "DESCRIPTION": "API documentation for falling_sound_dev_118910 App",
    "VERSION": "v1",
}
